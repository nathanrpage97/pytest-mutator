...
from . import add_mutations_by_file
from . import check_coverage_data_filepaths
from . import close_active_queues
from . import compute_exit_code
from . import config_from_setup_cfg
from . import guess_paths_to_mutate
from . import mutate_file
from . import mutmut_config
from . import popen_streaming_output
from . import print_status
from . import python_source_files
from . import read_coverage_data
from . import read_patch_data
from . import run_mutation_tests
from .cache import cached_hash_of_tests
from .cache import cached_test_time
from .cache import create_html_report
from .cache import filename_and_mutation_id_from_pk
from .cache import get_unified_diff
from .cache import hash_of_tests
from .cache import print_result_cache
from .cache import print_result_cache_junitxml
from .cache import set_cached_test_time
...
"""
    ...
    parse_run_argument(
        argument, config, dict_synonyms, mutations_by_file, paths_to_exclude, paths_to_mutate, tests_dirs
    )
